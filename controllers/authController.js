...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //3) if everything is ok,send token as response to client
...
exports.restrictTo =
  (...roles) =>
  (req, res, next) => {
    //roles is ['admin','lead-guide']...default role is 'user
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  //2)CHECK IF POSTED PASSWPRD IS CORRECT
